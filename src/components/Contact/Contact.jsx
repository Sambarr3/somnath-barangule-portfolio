...
const socialLinks = [
  {
    href: "https://github.com/Sambarr3",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/somnath-barangule-278115288/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://x.com/bbSaM911?t=Jq6KqfKeSXRLHHPjQdIJuQ&s=09",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/hayy.sam_/",
    icon: (
      <svg
        width="25"
        height="24"
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex-col ">
          ...
          <p className="text-zinc-400 mt-3 mb-3 max-w-[50ch] lg:max-w-[30ch] reveal-up">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-colors hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/bejrvgva"
          method="post"
